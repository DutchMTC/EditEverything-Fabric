...
public class GuiMetaModifier extends GuiModifier<ItemStack> {
    ...
    public void init() {
        ...
        addRenderableWidget(new EEButton(width / 2 - 100, height / 2 - 21 + 21 * ++i, 200, 20,
        ...
        addRenderableWidget(new EEButton(width / 2 - 100, height / 2 - 17 + 21 * ++i, 100, 20,
                Component.translatable("gui.done"), b -> {
            set(stack);
            getMinecraft().setScreen(parent);
        }));
        addRenderableWidget(new EEButton(width / 2 + 1, height / 2 - 17 + 21 * i, 99, 20,
