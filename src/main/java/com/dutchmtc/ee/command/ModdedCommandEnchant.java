...
public class ModdedCommandEnchant extends ModdedCommand {
    ...
    public ModdedCommandEnchant() {
        super("enchant", "cmd.ee.enchant", CommandClickOption.suggestCommand);
        addAlias("en");
    }
    ...
    protected Command<CommandSourceStack> onNoArgument() {
        return c -> {
            ...
            for (EnchantmentInstance data : EnchantmentHelper.selectEnchantment(EEMod.RANDOM_SOURCE, is, 30,
